...
public protocol LBXScanViewControllerDelegate {
 ...
 class LBXScanViewController: MainViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
 ...
 //返回扫码结果，也可以通过继承本控制器，改写该handleCodeResult方法即可
   ...
   public  var isNeedCodeImage = false
    ...
    override open func viewDidLoad() {
        ...
        self.setNormalNaviBar(title: LanguageHelper.getString(key: "scan"))
    ...
    open func drawScanView()
    {
        if qRScanView == nil
        {
            ...
            qRScanView?.frame.origin.y = MainViewControllerUX.naviNormalHeight
