...
class MainTabBarController: UITabBarController {
    ...
    func setupChildVcs() {
        ...
        let quotesVC = addChildVc(QuotesVC(), title: LanguageHelper.getString(key: "quotes_tab"), imageName: "ic_quotes_tab_n", selectedImageName: "ic_quotes_tab_s")
...
//        let informationVC = addChildVc(MessageVC(), title: LanguageHelper.getString(key: "tab_Information"), imageName: "ic_tabBar_information_n", selectedImageName: "ic_tabBar_information_s")
        ...
        viewControllers = [homeVc,businessVC,quotesVC,informationVC,mineVc]
